- <strong>Personal Ledger Agent</strong>. A ChatGPT Connector and MCP server for natural-language bookkeeping, with Supabase storage, export tools, and local CSV / Markdown / monthly reports. [[Code]](https://github.com/icn1Vad/personal-ledger-agent)
...
- <strong>GNNShap to Cancer</strong>. A research-oriented codebase exploring GNN explanation methods and cancer-related graph learning workflows. [[Code]](https://github.com/icn1Vad/GNNShap-to-Cancer)

- <strong>AI Learning & Research Log</strong>. A public log for daily AI/ML learning, research notes, and portfolio artifacts. [[Code]](https://github.com/icn1Vad/ai-learning-research-log)
